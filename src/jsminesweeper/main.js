/*----- constants -----*/
var bombImage = '<img src="imagesminesweeper/bomb.png">';
var flagImage = '<img src="imagesminesweeper/flag.png">';
var wrongBombImage = '<img src="imagesminesweeper/wrong-bomb.png">'
var sizeLookup = {
...
function buildTable() {
  ...
  <tr>
    <td class="menu" id="window-title-bar" colspan="${size}">
      <div id="window-title"><img src="imagesminesweeper/mine-menu-icon.png"> Minesweeper</div>
      <div id="window-controls"><img src="imagesminesweeper/window-controls.png"></div>
    </td>
  <tr>
    ...
    <tr>
      <td class="menu" colspan="${size}">
          <section id="status-bar">
            ...
            <div id="reset"><img src="imagesminesweeper/smiley-face.png"></div>
...
function render() {
  ...
  if (hitBomb) {
    document.getElementById('reset').innerHTML = '<img src=imagesminesweeper/dead-face.png>';
    runCodeForAllCells(function(cell) {
    ...
    document.getElementById('reset').innerHTML = '<img src=imagesminesweeper/cool-face.png>';
    clearInterval(timerId);
  }
};
