# games-a-go [![Build Status][travis-image]][travis-url]

> My supreme extension
...
[travis-image]: https://travis-ci.org/HasselGR/games-a-go.svg?branch=master
[travis-url]: https://travis-ci.org/HasselGR/games-a-go
